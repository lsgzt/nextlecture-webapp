          ...
          <div className="container grid items-center gap-12 pb-15 pt-8 sm:pb-20 sm:pt-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16 lg:pb-26 lg:pt-12">
            <div className="relative z-10 max-w-2xl">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
                ...
                <Link href="/download" className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl border border-border bg-card px-5 text-base font-semibold text-foreground shadow-sm transition hover:-translate-y-0.5 hover:border-teal-700/30 hover:text-teal-700 active:scale-[0.97] dark:hover:text-teal-300">
                  Android App
                </Link>
